...
HD_PWD='C:/Users/ericp/Xilinx/mu2e_monitor_firmware_original/mu2e_monitor_firmware_original/firmware_New_v2/mu2e_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_fmc228_pcie.vdi -applog -m64 -messageDb vivado.pb -mode batch -source top_fmc228_pcie.tcl -notrace
